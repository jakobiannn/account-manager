...
public interface UserService {
    ...
    List<User> findAll();
    MessageRespone updateUser(User user) throws UserNotFoundException, WrongEditRequestException;
    MessageRespone deleteUser(String login) throws UserNotFoundException;

    MessageRespone changePass(User user) throws UserNotFoundException;
}
